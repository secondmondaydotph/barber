            ...
            <div class="row g-0 align-items-center">
                <div class="col-lg-6 hero-header-text py-5">
                    <div class="py-5 px-3 ps-lg-0">
                        ...
                        <h1 class="display-1 mb-4 animated slideInLeft">Modern Grooming for Everyone</h1>
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/assets/public/img/hero-slider-1.jpg" alt="">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/assets/public/img/hero-slider-2.jpg" alt="">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/assets/public/img/hero-slider-3.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                    <img class="img-fluid mb-3" src="${pageContext.request.contextPath}/assets/public/img/about.jpg" alt="">
            ...
            <div class="row g-4 g-md-0 text-center">
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-end wow fadeIn" data-wow-delay="0.1s">
                        <div class="barber-service-icon" aria-hidden="true">CUT</div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-lg-end wow fadeIn" data-wow-delay="0.3s">
                        <div class="barber-service-icon" aria-hidden="true">STYLE</div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-end border-lg-end-0 wow fadeIn"
                        data-wow-delay="0.5s">
                        <div class="barber-service-icon" aria-hidden="true">BEARD</div>
                        <h3 class="mb-3">Beard Trim</h3>
                        <p class="mb-3">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit clita duo justo
                            et tempor eirmod magna dolore erat amet</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-lg-bottom-0 border-lg-end wow fadeIn"
                        data-wow-delay="0.1s">
                        <div class="barber-service-icon" aria-hidden="true">KIDS</div>
                        <h3 class="mb-3">Kids' Haircut</h3>
                        <p class="mb-3">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit clita duo justo
                            et tempor eirmod magna dolore erat amet</p>
                        <a class="btn btn-sm btn-primary text-uppercase" href="">Read More <i
                                class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-end wow fadeIn" data-wow-delay="0.3s">
                        <div class="barber-service-icon" aria-hidden="true">SHAVE</div>
                        <h3 class="mb-3">Hot Towel Shave</h3>
                        <p class="mb-3">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit clita duo justo
                            et tempor eirmod magna dolore erat amet</p>
                        <a class="btn btn-sm btn-primary text-uppercase" href="">Read More <i
                                class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="barber-service-icon" aria-hidden="true">FULL</div>
                        <h3 class="mb-3">Grooming Package</h3>
                        <p class="mb-3">Clita erat ipsum et lorem et sit, sed stet no labore lorem sit clita duo justo
                            et tempor eirmod magna dolore erat amet</p>
                        <a class="btn btn-sm btn-primary text-uppercase" href="">Read More <i
                                class="bi bi-arrow-right"></i></a>
            ...
            <div class="row g-4 team">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/assets/public/img/team-1.jpg" alt="">
                        <div class="team-overlay">
                            <p class="text-primary mb-1">Master Barber</p>
                            <h4>Marco Santos</h4>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/assets/public/img/team-2.jpg" alt="">
                        <div class="team-overlay">
                            <p class="text-primary mb-1">Barber &amp; Stylist</p>
                            <h4>Mia Reyes</h4>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-dark btn-sm-square border-2 me-3" href="">
                                    <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/assets/public/img/team-3.jpg" alt="">
                        <div class="team-overlay">
                            <p class="text-primary mb-1">Grooming Specialist</p>
                            <h4>Paolo Cruz</h4>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-dark btn-sm-square border-2 me-3" href="">
                                    <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="${pageContext.request.contextPath}/assets/public/img/team-4.jpg" alt="">
                        <div class="team-overlay">
                            <p class="text-primary mb-1">Senior Barber</p>
                            <h4>Nico Garcia</h4>
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-dark btn-sm-square border-2 me-3" href="">
                                    <i class="fab fa-facebook-f"></i>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.3s">
                <div class="text-center bg-light p-4">
                    ...
                    <img class="img-fluid mx-auto border p-1 mb-3" src="${pageContext.request.contextPath}/assets/public/img/testimonial-1.jpg" alt="">
                ...
                <div class="text-center bg-light p-4">
                    <i class="fa fa-quote-left fa-3x mb-3"></i>
                    <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum et lorem et sit.</p>
                    <img class="img-fluid mx-auto border p-1 mb-3" src="${pageContext.request.contextPath}/assets/public/img/testimonial-2.jpg" alt="">
                    <h4 class="mb-1">Client Name</h4>
                    <span>Profession</span>
                </div>
                <div class="text-center bg-light p-4">
                    <i class="fa fa-quote-left fa-3x mb-3"></i>
                    <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum et lorem et sit.</p>
                    <img class="img-fluid mx-auto border p-1 mb-3" src="${pageContext.request.contextPath}/assets/public/img/testimonial-3.jpg" alt="">
                    <h4 class="mb-1">Client Name</h4>
                    <span>Profession</span>
                </div>
                <div class="text-center bg-light p-4">
                    <i class="fa fa-quote-left fa-3x mb-3"></i>
                    <p>Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et eos. Clita erat ipsum et lorem et sit.</p>
                    <img class="img-fluid mx-auto border p-1 mb-3" src="${pageContext.request.contextPath}/assets/public/img/testimonial-4.jpg" alt="">
                    <h4 class="mb-1">Client Name</h4>
                    <span>Profession</span>
                </div>
            </div>
